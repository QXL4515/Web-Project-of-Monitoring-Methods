...
public class ReadWebServiceInformationDataFromTxt implements ReadListDataFromTxt{
	private String path;
	private ArrayList<WebServiceInformation> webServiceList;
	
	public ReadWebServiceInformationDataFromTxt(String path){
		this.path = path;
	}
	
	public ArrayList<WebServiceInformation> readData(){
		...
		try {
			...
			webServiceList = new ArrayList<WebServiceInformation>();
			String temp;
			while ((temp=br.readLine()) != null) {
				...
				webServiceList.add(new WebServiceInformation(id, website, provider, nation));
			}
		} catch (Exception e) {
